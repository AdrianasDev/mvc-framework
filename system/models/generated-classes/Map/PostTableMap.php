...
class PostTableMap extends TableMap
{
     ...
     */
    const DATABASE_NAME = 'CMSproject';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Body', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'title', 'body', ),
        self::TYPE_COLNAME       => array(PostTableMap::ID, PostTableMap::TITLE, PostTableMap::BODY, ),
        self::TYPE_RAW_COLNAME   => array('ID', 'TITLE', 'BODY', ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'body', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Body' => 2, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'title' => 1, 'body' => 2, ),
        self::TYPE_COLNAME       => array(PostTableMap::ID => 0, PostTableMap::TITLE => 1, PostTableMap::BODY => 2, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'TITLE' => 1, 'BODY' => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'body' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PostTableMap::TITLE);
            $criteria->addSelectColumn(PostTableMap::BODY);
        } else {
