...
abstract class Post implements ActiveRecordInterface
{
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PostTableMap::ID;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = PostTableMap::TITLE;
        }
    ...
    public function setBody($v)
    {
        ...
        if ($this->body !== $v) {
            $this->body = $v;
            $this->modifiedColumns[] = PostTableMap::BODY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \Post object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PostTableMap::TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'TITLE';
        }
        if ($this->isColumnModified(PostTableMap::BODY)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PostTableMap::TITLE)) $criteria->add(PostTableMap::TITLE, $this->title);
        if ($this->isColumnModified(PostTableMap::BODY)) $criteria->add(PostTableMap::BODY, $this->body);
