 ...
 * @method     array findByTitle(string $title) Return ChildPost objects filtered by the title column
 * @method     array findByBody(string $body) Return ChildPost objects filtered by the body column
 *
 */
abstract class PostQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'CMSproject', $modelName = '\\Post', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT ID, TITLE, BODY FROM post WHERE ID = :p0';
        try {
    ...
    public function filterByTitle($title = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PostTableMap::TITLE, $title, $comparison);
    }
    ...
    public function filterByBody($body = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PostTableMap::BODY, $body, $comparison);
    }
